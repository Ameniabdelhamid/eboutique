...
fixed = gtk_fixed_new ();
 ...
 g_signal_connect(G_OBJECT(consproWindow),"destroy",G_CALLBACK(onDestroyConpro),NULL);
 ...
 /* tout les parametre des images */
   ...
   /* On utilise les balises */
    ...
    nomLabel = gtk_label_new("Libellé");
     sUtf8 = g_locale_to_utf8("<span face=\"Georgia\" size=\"80\" foreground=\"#920391\"><b>Libellé</b></span>\n",-1, NULL, NULL, NULL);
   ...
   sUtf8 = g_locale_to_utf8("<span face=\"Georgia\" size=\"80\" foreground=\"#920391\"><b>Image</b></span>\n",-1, NULL, NULL, NULL);
    ...
    g_free(sUtf8);
    villeLabel = gtk_label_new("Modifier  ");
    ...
    g_free(sUtf8);
   code_pLabel =gtk_label_new("Effacer");
      sUtf8 = g_locale_to_utf8("<span face=\"Georgia\" size=\"40\" foreground=\"#920391\"><b>Effacer</b></span>\n",-1, NULL, NULL, NULL);
   ...
   gtk_fixed_put(GTK_FIXED(fixed),villeLabel,930,450);
    gtk_fixed_put(GTK_FIXED(fixed),code_pLabel,1130,450);
...
modButton = gtk_button_new_with_label("Modifier");
  ...
  gtk_fixed_put(GTK_FIXED(fixed),BackButton,1250,600);
     ...
     g_signal_connect(G_OBJECT(consproWindow),"destroy",G_CALLBACK(onDestroyConpro),NULL);
   g_signal_connect (effButton,"button_press_event",G_CALLBACK (onClickConpro), 1);
  g_signal_connect (BackButton,"button_press_event",G_CALLBACK (onClickConpro), 2);
    g_signal_connect (modButton,"button_press_event",G_CALLBACK (onClickConpro), 3);
     ...
     sprintf(text,"%s",row[4]);
            ...
            x=x+200;
             ...
             gtk_fixed_put(GTK_FIXED(fixed),adresseLibele,x,y+50);
                          gtk_fixed_put(GTK_FIXED(fixed),modButton,930,y);
